        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {lessonComponents.map((item, index) => (
              <div 
                key={item.label}
                className="group tactical-card p-4 rounded-xl text-center transition-all duration-300 hover:-translate-y-1"
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {learningFlow.map((item, index) => (
                ...
                >
                  <div className="tactical-card p-6 rounded-xl text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
